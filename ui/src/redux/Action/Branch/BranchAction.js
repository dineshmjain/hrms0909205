...
import {
  ...
  branchKYCGetApi,
  branchRadiusGetApi,
  branchRadiusUpdateApi,
  BranchStatusUpdateApi,
  branchPolygonUpdateApi
...
export const BranchGetAction = createAsyncThunk(
  "BranchList",
...
export const BranchEditAction = createAsyncThunk(
  "BranchEdit",
  async (branchDetails, { rejectWithValue }) => {
    console.log(branchDetails);
    try {
...
export const MappedBranches = createAsyncThunk(
  "BranchList",
  async (branchDetails, { rejectWithValue }) => {
    console.log(branchDetails);
    try {
...
export const BranchStatusUpdateAction = createAsyncThunk(
  "BranchStatus",
  async (branchDetails, { rejectWithValue }) => {
    console.log(branchDetails);
    try {
...
export const BranchKycCreateAction = createAsyncThunk(
  "BranchKYCUpdate",
  async (branchDetails, { rejectWithValue }) => {
    console.log(branchDetails);
    try {
...
export const BranchKycGetAction = createAsyncThunk(
  "BranchKYCGet",
  async (branchDetails, { rejectWithValue }) => {
    console.log(
      branchDetails,
...
export const BranchRadiusGetAction = createAsyncThunk(
  "BranchRadiusGet",
  async (branchDetails, { rejectWithValue }) => {
    console.log(
      branchDetails,
...
export const BranchRadiusUpdateAction = createAsyncThunk(
  "BranchRadiusUpdate",
  async (branchDetails, { rejectWithValue }) => {
    console.log(
      branchDetails,
...
export const BranchPolygonUpdateAction = createAsyncThunk(
  "BranchPolygonUpdate",
  async (branchDetails, { rejectWithValue }) => {
    try {
      const data = await branchPolygonUpdateApi(branchDetails);
      console.log("Branch Polygon Update Success -->", data);
      return data;
    } catch (error) {
      console.log("Branch Polygon Update Error -->", error);
      return rejectWithValue(error || { message: "Unknown error occurred" });
    }
  }
);

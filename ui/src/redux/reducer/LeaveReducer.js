...
import { LeavePolicyCreateAction, LeavePolicyGetAction, LeavePolicyUpdateAction, LeavePolicyStatusUpdateAction, LeaveRequestGetAction, LeaveRequestApproveRejectAction, LeaveBalanceUserAction } from "../Action/Leave/LeaveAction";
    ...
    extraReducers: (builder) => {
        ...
        builder
            ...
            .addCase(LeavePolicyCreateAction.rejected, (state, action) => {
                ...
                const validationMessage = backendError?.data.validation?.body?.message || backendError?.message || 'Something went wrong';
        ...
        builder
            ...
            .addCase(LeavePolicyGetAction.fulfilled, (state, action) => {
                ...
                state.error = '';
                state.loading = false;
                state.PolicyList = action?.payload.data.data || []; // Ensure this is the correct path to the data

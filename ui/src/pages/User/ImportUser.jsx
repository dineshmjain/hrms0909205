...
import { EmployeeBulkUploadAction, EmployeeSampleFormatAction } from '../../redux/Action/Employee/EmployeeAction';
            ...
            <Card className="bg-gray-50 ml-12">
                <CardBody>
                    ...
                    <ul className="list-decimal list-inside space-y-2 text-gray-700 text-sm">
                        ...
                        <li>
                            <strong>Fill Details:</strong> Enter all employee information as per the sample format.
                        </li>
                        <li>

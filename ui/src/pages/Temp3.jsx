          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {branches.reduce((total, branch) => total + branch.adjustments.length, 0)}
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">₹400-1.3K</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">SecureForce HRMS</h1>
                <p className="text-sm text-gray-500">Admin Pricing Dashboard</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500">admin@secureforce.com</p>
              </div>
            </div>
          </div>
        </div>

...
import { OrganizationCreateAction, OrganizationDefaultCreateAction, OrganizationGroupCreateAction } from "../../redux/Action/Oraganization/OrganizationAction";
...
function Add() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = form.structure === "branch" 
      ? await dispatch(OrganizationDefaultCreateAction(dataToSend)) 
      :  await dispatch(OrganizationGroupCreateAction(dataToSend)); 
      ...
      if (meta?.requestStatus === "fulfilled") {
        ...
        // debugger
        toast.success(payload?.message || `You've successfully created your account`);

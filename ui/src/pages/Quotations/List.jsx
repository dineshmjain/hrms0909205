...
const List = () => {
  ...
  const addButton = () => navigate("/quotations/add");
  const editButton = (quotation) => navigate("/quotations/edit", { state: quotation });
  ...
  return (
    <div className="flex flex-col gap-4 p-2 w-full h-full">
      <div className="flex justify-between">
        {" "}
        <h6 className="font-semibold text-xl ">Quotation List</h6>{" "}
      ...
      <div>
        ...
        <SingleSelectDropdown  hideLabel={true}
                  showTip={false}  inputName="Select Lead"/>
        </div>
      </div>

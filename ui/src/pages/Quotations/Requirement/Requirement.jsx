...
const Requirement = ({ onChange, onValidate }) => {
  ...
  return (
   ...
   <div className="flex flex-row flex-1 min-w-[200px]">
           <Typography variant="h6" className="text-gray-900 font-semibold text-lg">
          Requirements
           </Typography>
         <MdAdd  className='h-5 w-5 text-center'/>
           </div>

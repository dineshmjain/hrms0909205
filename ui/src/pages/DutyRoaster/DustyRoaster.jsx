...
//         ref={filterRef}
//       >
//         <SwapDialog swapDiv={swapDiv} setSwapDiv={setSwapDiv} empDetails={empDetails} selectedDate={selectedDate} refrencesData={refrencesData}/>
//         <ShiftDialog
...
//           <div
//             ref={pickerRef}
//             className="absolute top-14 left-1/2 transform -translate-x-1/2 z-20 bg-white shadow-xl rounded-lg p-3 border border-gray-200 transition-all duration-200 animate-fade-in"
//           >
...
//           className="relative overflow-auto bg-white rounded-lg shadow-inner scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
//         >
...
//                 <Typography className="text-gray-800 font-semibold text-sm leading-tight">
...
//                     }}
//                     className={`p-2 items-center text-center border-l border-gray-300 cursor-pointer select-none ${isSelected ? "bg-blue-100 border-blue-300" : ""
//                       }`}
...
// export default DutyRoaster;import { IconButton, Typography } from "@material-tailwind/react";
import React, {
  useCallback,
  useEffect,
  useMemo,

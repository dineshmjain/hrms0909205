...
const List = () => {
  ...
  const addButton = () => navigate("/lead/add");
  const editButton = (lead) => navigate("/lead/edit", { state: lead });
  ...
  return (
    <div className="flex flex-col gap-4 p-2 w-full h-full">
      <div className="flex justify-between">
        {" "}
        <h6 className="font-semibold text-xl ">Lead List</h6>{" "}
      ...
      <div>
        ...
        <SingleSelectDropdown  hideLabel={true}
                  showTip={false}  inputName="Select Organization"/>
        </div>
      </div>
